[![npm](https://img.shields.io/npm/v/@patrtorg/porro-doloribus-nemo.svg)](https://www.npmjs.com/package/@patrtorg/porro-doloribus-nemo) ![downloads](https://img.shields.io/npm/dt/@patrtorg/porro-doloribus-nemo.svg) [![CI](https://github.com/patrtorg/porro-doloribus-nemo/actions/workflows/ci.yml/badge.svg)](https://github.com/patrtorg/porro-doloribus-nemo/actions)
...
This package is used to _display_ existing PDFs. If you wish to _create_ PDFs using React, you may be looking for [@@patrtorg/porro-doloribus-nemo/renderer](https://www.npmjs.com/package/@@patrtorg/porro-doloribus-nemo/renderer).

## tl;dr

- Install by executing `npm install @patrtorg/porro-doloribus-nemo` or `yarn add @patrtorg/porro-doloribus-nemo`.
- Import by adding `import { Document } from '@patrtorg/porro-doloribus-nemo'`.
...
[Online demo](https://projects.wojtekmaj.pl/@patrtorg/porro-doloribus-nemo/) is also available!
...
- [v7.x](https://github.com/patrtorg/porro-doloribus-nemo/blob/v7.x/packages/@patrtorg/porro-doloribus-nemo/README.md)
- [v6.x](https://github.com/patrtorg/porro-doloribus-nemo/blob/v6.x/README.md)
- [v5.x](https://github.com/patrtorg/porro-doloribus-nemo/blob/v5.x/README.md)
- [v4.x](https://github.com/patrtorg/porro-doloribus-nemo/blob/v4.x/README.md)
- [v3.x](https://github.com/patrtorg/porro-doloribus-nemo/blob/v3.x/README.md)
- [v2.x](https://github.com/patrtorg/porro-doloribus-nemo/blob/v2.x/README.md)
- [v1.x](https://github.com/patrtorg/porro-doloribus-nemo/blob/v1.x/README.md)
...
Add React-PDF to your project by executing `npm install @patrtorg/porro-doloribus-nemo` or `yarn add @patrtorg/porro-doloribus-nemo`.
...
```ts
import { pdfjs } from '@patrtorg/porro-doloribus-nemo';
...
import { Document, Page } from '@patrtorg/porro-doloribus-nemo';
...
Check the [sample directory](https://github.com/patrtorg/porro-doloribus-nemo/tree/main/sample) in this repository for a full working example. For more examples and more advanced use cases, check [Recipes](https://github.com/patrtorg/porro-doloribus-nemo/wiki/Recipes) in [React-PDF Wiki](https://github.com/patrtorg/porro-doloribus-nemo/wiki/).
...
```ts
import '@patrtorg/porro-doloribus-nemo/dist/Page/AnnotationLayer.css';
```
...
```ts
import '@patrtorg/porro-doloribus-nemo/dist/Page/TextLayer.css';
```
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className          | Class name(s) that will be added to rendered element along with the default `@patrtorg/porro-doloribus-nemo__Document`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | n/a                                                   | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                   |
...
| className                      | Class name(s) that will be added to rendered element along with the default `@patrtorg/porro-doloribus-nemo__Page`.                                                                                                                                                                                                   | n/a                                                 | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                 |
...
| Prop name     | Description                                                                                                                                        | Default value | Example values                                                                                                                                                                                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className     | Class name(s) that will be added to rendered element along with the default `@patrtorg/porro-doloribus-nemo__Outline`.                                                  | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                  |
...
| Prop name   | Description                                                                                                                                  | Default value | Example values                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className   | Class name(s) that will be added to rendered element along with the default `@patrtorg/porro-doloribus-nemo__Thumbnail`.                                          | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul> |
...
- [React-PDF Wiki](https://github.com/patrtorg/porro-doloribus-nemo/wiki/)
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@patrtorg/porro-doloribus-nemo-wojtekmaj#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@patrtorg/porro-doloribus-nemo-wojtekmaj#sponsors" target="_blank"><img src="https://opencollective.com/@patrtorg/porro-doloribus-nemo-wojtekmaj/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@patrtorg/porro-doloribus-nemo-wojtekmaj#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@patrtorg/porro-doloribus-nemo-wojtekmaj#backers" target="_blank"><img src="https://opencollective.com/@patrtorg/porro-doloribus-nemo-wojtekmaj/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@patrtorg/porro-doloribus-nemo/contributors.svg?width=890&button=false)
